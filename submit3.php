<?php
	...
	if (mysqli_num_rows($data)>0){
		...
		if ((strcmp($roles[0],"1") == 0) or (strcmp($roles[0],"2") == 0)){
			...
			mysqli_stmt_bind_param($sth2, "sssssisssssssss", $name, $icon, $version, $author, $url, $type, $description, $url3, $day, $titleid, $long_description, $sshot, $source, $release_page, $trailer);
