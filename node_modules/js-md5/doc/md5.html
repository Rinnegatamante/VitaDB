...
<span class="param-type">String</span>
    ...
    <pre class="prettyprint"><code>md5.hex('The quick brown fox jumps over the lazy dog');// equal tomd5('The quick brown fox jumps over the lazy dog');</code></pre>
...
<span class="param-type"><a href="Md5_.html">Md5</a></span>
    ...
    <pre class="prettyprint"><code>var hash = md5.update('The quick brown fox jumps over the lazy dog');// equal tovar hash = md5.create();hash.update('The quick brown fox jumps over the lazy dog');</code></pre>
