<?php
	...
	$sth = mysqli_prepare($con,"SELECT name,icon,version,author,type,url,description,id,data,date,titleid,screenshots,long_description,downloads FROM vitadb WHERE id=?");
